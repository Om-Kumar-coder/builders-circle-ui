/*
  ...
  - Added the required column `filePath` to the `document_versions` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_document_versions" ("createdAt", "documentId", "id", "uploadedBy", "versionNumber") SELECT "createdAt", "documentId", "id", "uploadedBy", "versionNumber" FROM "document_versions";
...
INSERT INTO "new_documents" ("createdAt", "createdBy", "folderId", "id", "isActive", "securityLabel", "size", "title", "updatedAt") SELECT "createdAt", "createdBy", "folderId", "id", "isActive", "securityLabel", "size", "title", "updatedAt" FROM "documents";
